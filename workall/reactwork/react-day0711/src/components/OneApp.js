        ...
        setInputs(
            {
                ...
                [name]:value //같은 name 을 찾아서 value 값 넣기
            }
        )
    }
            ...
            <table className='table table-bordered' style={{width:'300px'}}>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='color' className='form-control'
                             value={inputs.scolor} name="scolor"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type='text' className='form-control'
                             value={inputs.sprice} name="sprice"
                             onChange={changeDataEvent}/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select className='form-select' name="sphoto"
                             onChange={changeDataEvent}>
                    ...
                    <tr>
                        <td colSpan={2} align='center'>
                            <Button variant='contained'  color='success'
                             size="small" onClick={addSangpumEvent}>상품 추가</Button>
                            &nbsp;
                            <Button variant='contained'  color='info'
                             size="small" onClick={initDataEvent}>입력값초기화</Button>
                        </td>
                    </tr>
                    {/* <tr>
                        <td colSpan={2} align='center'>
